    ...
    Tables: {
      ...
      contrato_modalidades: {
        Row: {
          ...
          modalidade_cor: string | null;
          categoria_icone: string | null;
          tipo_acesso: 'padrao' | 'sessoes_semana' | 'pacote_aulas' | 'gonutri' | string;
          ...
          periodos_horario: Json | null;
          permite_reposicao: boolean;
          max_reposicoes: number | null;
          limite_reposicoes_periodo: 'semana' | 'mes' | 'contrato' | string | null;
